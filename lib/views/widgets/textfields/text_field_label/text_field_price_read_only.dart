...
class MyTextFieldPriceReadOnly extends StatefulWidget {
  ...
  const MyTextFieldPriceReadOnly(
      {super.key,
  ...
  @override
  State<MyTextFieldPriceReadOnly> createState() => _MyTextFieldPriceReadOnlyState();
}

class _MyTextFieldPriceReadOnlyState extends State<MyTextFieldPriceReadOnly> {
  @override
  void initState() {
    if ((widget.defaultValue ?? 0) > 0) {
      widget.textEditingController.text = widget.defaultValue.toString();
    } else {
