  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
            child: Text(
          "MÓN ĂN BÀN - ${widget.order.table!.name}",
                                  ...
                                  ? Column(
                                      children: [
                                        ListTile(
                                          ...
                                          trailing: orderDetailNeedSplitArray[
                                                          index]
                                                      .isSelected ==
                                                  true
                                              ? SizedBox(
                                                                    ...
                                                                    ListTile(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            mainAxisAlignment:
                                                                                MainAxisAlignment.start,
                                                                            children: [
                                                                              widget.order.order_details[index].listCombo[indexCombo].image != ""
                                                                                  ? ClipRRect(
                                                                                      borderRadius: BorderRadius.circular(5),
                                                                                      child: Image.network(
                                                                                        widget.order.order_details[index].listCombo[indexCombo].image ?? defaultFoodImageString,
                                                                                        width: 40,
                                                                                        height: 40,
                                                                                        fit: BoxFit.cover,
                                                                                      ),
                                                                      ...
                                                                      title: Marquee(
                                                                          ...
                                                                          child: RichText(
                                                                              text: TextSpan(
                                                                            children: [
                                                                              TextSpan(text: widget.order.order_details[index].listCombo[indexCombo].name, style: orderDetailNeedSplitArray[index].isSelected == true ? textStyleWhiteRegular16 : textStyleFoodNameBold16),
                                                                            ],
                                                                          ))),
                                                                    ),
                                                                  ],
