...
class CustomDialogAddRecipeDetail extends StatefulWidget {
  final String food_id;
  const CustomDialogAddRecipeDetail({
    Key? key,
    required this.food_id,
  }) : super(key: key);

  @override
  State<CustomDialogAddRecipeDetail> createState() =>
      _CustomDialogAddRecipeDetaillState();
}

class _CustomDialogAddRecipeDetaillState
    extends State<CustomDialogAddRecipeDetail> {
  @override
  void dispose() {
    super.dispose();
  }
                    ...
                    SizedBox(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: () => {
                              recipeController.createRecipe(widget.food_id,
