          ...
          child: SizedBox(
            ...
            child: Column(
              ...
              children: [
                            ...
                            Container(
                              ...
                              child: TextField(
                                onChanged: (value) => {
                                  setState(() {
                                    keySearch = value;
                                    ingredientController.getIngredientsOfFood(
                                      value,
                                    );
                                  }),
                                },
                                      ...
                                      return ResponsiveGridList(
                                        ...
                                        children: List.generate(
                                            ingredientController
                                                .ingredientsOfFood
                                                .length, (index) {
                                          var ingredient = ingredientController
                                              .ingredientsOfFood[index];
                                          return InkWell(
                                            onTap: () => {
                                              setState(() {
                                                if (isExistInRecipe(
                                                                    ...
                                                                    children: [
                                                                      InkWell(
                                                                        onTap:
                                                                          ...
                                                                          setState(
                                                                              () {
                                                                            if ((recipeDetail.new_quantity ?? 0) >
                                                                                0) {
                                                                      ...
                                                                      InkWell(
                                                                        onTap:
                                                                          ...
                                                                          setState(
                                                                              () {
                                                                            recipeDetail.new_quantity =
                                                                                double.parse(((recipeDetail.new_quantity ?? 0.1) + 0.1).toStringAsFixed(1));
                                                                          });
                                                                        },
                                                                        child:
                                                                            Container(
                ...
                Utils.filterSelected(ingredientController.ingredientsOfFood)
                        .isNotEmpty
                    ? Obx(() {
                        return Container(
                            ...
                            children: [
                              InkWell(
                                onTap: () async {
                                  ...
                                  if (Utils.filterSelected(ingredientController
                                          .ingredientsOfFood)
                                      .isNotEmpty) {
                                    final result = await showDialog(
                                      context: context,
