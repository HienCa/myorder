...
class AddFoodComboPage extends StatefulWidget {
  const AddFoodComboPage({
    Key? key,
  }) : super(key: key);

  @override
  State<AddFoodComboPage> createState() => _AddFoodComboPageState();
}

class _AddFoodComboPageState extends State<AddFoodComboPage> {
  var isActive = true;
                    ...
                    child: Column(
                      children: [
                        ...
                        ListTile(
                              ...
                              onChanged: (bool? value) {
                                setState(() {
                                  ...
                                  if (isCheckCombo == false) {
                                    Utils.refeshSelected(foodController.foodCombos);
                                  }
                                });
                              },
                          ...
                          title: Utils.counterSelected(foodController.foodCombos) > 0
                              ? Text(
                                      ...
                                      child: ListView.builder(
                                        ...
                                        itemBuilder: (context, index) =>
                                          ...
                                          onTap: () => {
                                            setState(() {
                                              unSelectedFood(
                                                  foodController.foodCombos[index]);
                                            })
                                          },
                                          child: Container(
                                            alignment: Alignment.center,
