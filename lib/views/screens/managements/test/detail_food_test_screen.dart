...
class DetailFoodComboPage extends StatefulWidget {
  final FoodCombo food;
  const DetailFoodComboPage({
    Key? key,
    required this.food,
  }) : super(key: key);

  @override
  State<DetailFoodComboPage> createState() => _DetailFoodComboPageState();
}

class _DetailFoodComboPageState extends State<DetailFoodComboPage> {
  var isActive = true;
  ...
  void toggleSelectedFood(FoodCombo food) {
  ...
  void unSelectedFood(FoodCombo food) {
    print("UNSELECTED");
    print(food.isSelected);
    if (food.isSelected == true) {
      food.isSelected = false;
                    ...
                    child: Column(
                      children: [
                        ...
                        ListTile(
                          ...
                          title:
                              Utils.counterSelected(foodController.foodCombos) >
                                      0
                                  ? Text(
                                      "Món Combo (${Utils.counterSelected(foodController.foodCombos)})",
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: ListView.builder(
                                        ...
                                        itemCount:
                                            foodController.foodCombos.length,
                                        itemBuilder: (context, index) =>
                                            GestureDetector(
                                          onTap: () {
                                            setState(() {
                                              toggleSelectedFood(foodController
                                                  .foodCombos[index]);
                                            });
                                          },
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: InkWell(
                                  onTap: () => {
                                    listCombo = Utils.filterFoodComboSelected(
                                        foodController.foodCombos),
