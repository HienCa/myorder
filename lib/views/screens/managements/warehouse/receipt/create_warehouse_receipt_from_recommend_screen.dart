...
class WarehouseReceiptDetailFromRecommendScreen extends StatefulWidget {
  final WarehouseReceipt? warehouseReceipt;
  const WarehouseReceiptDetailFromRecommendScreen(
      {super.key, this.warehouseReceipt});
  @override
  State<WarehouseReceiptDetailFromRecommendScreen> createState() =>
      _WarehouseReceiptDetailFromRecommendScreenState();
}

class _WarehouseReceiptDetailFromRecommendScreenState
    extends State<WarehouseReceiptDetailFromRecommendScreen> {
