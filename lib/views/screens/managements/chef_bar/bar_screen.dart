...
class ManagementBarDetailPage extends StatefulWidget {
  const ManagementBarDetailPage({super.key});

  @override
  State<ManagementBarDetailPage> createState() => _ManagementBarDetailPageState();
}

class _ManagementBarDetailPageState extends State<ManagementBarDetailPage> {
