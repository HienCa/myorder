...
class ManagementBarDetailPage extends StatefulWidget {
  final ChefBar chefBar;
  const ManagementBarDetailPage({super.key, required this.chefBar});

  @override
  State<ManagementBarDetailPage> createState() =>
      _ManagementBarDetailPagePageState();
}

class _ManagementBarDetailPagePageState extends State<ManagementBarDetailPage> {
  ...
  void initState() {
    super.initState();
    chefBarOtherController.getBarByOrder(widget.chefBar.chef_bar_id, '');
    Utils.unCheckAll(chefBarOtherController.orderDetailOfBar.order_details);

    // isCheckAll = Utils.isCheckedAll(
    //     chefBarOtherController.orderDetailOfBar.order_details);
  }
      ...
      body: Column(
        ...
        children: [
          Container(
            ...
            child: TextField(
              onChanged: (value) {
                chefBarOtherController.getBarByOrder(
                        ...
                        onChanged: (bool? value) {
                          setState(() {
                            if (Utils.isCheckedAll(chefBarOtherController
                                .orderDetailOfBar.order_details)) {
                              ...
                              children: [
                                ...
                                InkWell(
                                  ...
                                  child: Container(
                                      ...
                                      child: Center(
                                        child: Text(
                                          "TRẠNG THÁI (${Utils.counterOrderDetailSelected(chefBarOtherController.orderDetailOfBar.order_details)})",
                                ...
                                InkWell(
                                  ...
                                  child: Container(
                                      ...
                                      child: Center(
                                        child: Text(
                                          "HỦY (${Utils.counterCancelStatusOrderDetailSelected(chefBarOtherController.orderDetailOfBar.order_details)})",
                                          style: textStyleWhiteBold16,
                                        ),
                                      )),
                                ),
              ...
              child: Obx(() {
                return ListView.builder(
                  ...
                  itemCount: chefBarOtherController
                      .orderDetailOfBar.order_details.length,
                  itemBuilder: (context, index) {
                    return Container(
                        margin: const EdgeInsets.only(
                            left: 0, right: 0, top: 0, bottom: 5),
                        decoration: chefBarOtherController.orderDetailOfBar
                        ...
                        child: ListTile(
                                      ...
                                      onChanged: (bool? value) {
                                        setState(() {
                                          setState(() {
                                            ...
                                            print(
                                                "isChecked - $value: ${chefBarOtherController.orderDetailOfBar.order_details[index].food!.name}");
                                          });
                                        });
                                      },
                                      activeColor: primaryColor,
                            ...
                            title: Marquee(
                              ...
                              child: Text(
                                  chefBarOtherController.orderDetailOfBar
                                      .order_details[index].food!.name,
                                  style: textStyleFoodNameBold16),
                            ),
                            subtitle: chefBarOtherController.orderDetailOfBar
                                        .order_details[index].food_status ==
                                    FOOD_STATUS_IN_CHEF
                                ? Text(
                                    "$FOOD_STATUS_IN_CHEF_STRING x ${chefBarOtherController.orderDetailOfBar.order_details[index].quantity}",
                                    style: textStyleMaking,
                                  )
                                : Text(
                                    "$FOOD_STATUS_COOKING_STRING x ${chefBarOtherController.orderDetailOfBar.order_details[index].quantity}",
                                    style: textStyleCooking,
                                  ),
                            trailing: chefBarOtherController.orderDetailOfBar
                                    .order_details[index].isSelected
                                ? SizedBox(
                                    width: 30,
                                    child: Row(
