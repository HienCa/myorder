...
class MyDialogAddSurcharge extends StatefulWidget {
  final Order order;
  const MyDialogAddSurcharge({
    Key? key,
    required this.order,
  }) : super(key: key);

  @override
  State<MyDialogAddSurcharge> createState() => _MyDialogAddSurchargeState();
}

class _MyDialogAddSurchargeState extends State<MyDialogAddSurcharge> {
