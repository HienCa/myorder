...
class ProfilePage extends StatefulWidget {
  ...
  @override
  State<ProfilePage> createState() => _EmployeeDetailPageState();
}

class _EmployeeDetailPageState extends State<ProfilePage> {
  var isActive = true;
    ...
    if (employee.employee_id == "") {
      ...
      return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Center(child: Text("CẬP NHẬT THÔNG TIN CÁ NHÂN")),
                                  ...
                                  if (!Utils.isValidLengthTextEditController(
                                      nameController, minlength2, maxlength255))
                                    {
                                      Utils.showStylishDialog(
                                          context,
                                          'THÔNG BÁO',
                                          'Họ tên phải từ $minlength2 đến $maxlength255 ký tự.',
